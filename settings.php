    ...
    <div class="wrapper">
      ...
      <nav id="sidebar">
        <ul class="list-unstyled mt-4 mb-5 px-3">
          ...
          <li>
            <a href="analytics.php"><span class="fa fa-gear"></span> Analytics</a>
          </li>
          <li>
            <a href="settings.php"><span class="fa fa-gear"></span> Settings</a>
          </li>
          <li>
            <a href="https://www.mdpi.com/2227-7390/12/2/297"><span class="fa fa-sticky-note"></span> Help</a>
          </li>
          </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title" id="staticBackdropLabel">Control Settings</h5>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    myModal.show();
            ...
            <p class="text-muted mb-0">
                You can easily adjust your settings to Home Page
            </p>
            </div>
    </div>
  </div>
